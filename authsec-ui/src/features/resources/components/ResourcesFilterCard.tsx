...
// Resource query parameters interface
...
export interface ResourcesFilterCardProps {
  onFiltersChange: (filters: Partial<ResourcesQueryParams>) => void;
  initialFilters?: Partial<ResourcesQueryParams>;
  resourcesData?: ResourceData[];
}

const ResourcesFilterCard = React.memo(({
  onFiltersChange,
  initialFilters = {},
  resourcesData: _resourcesData = []
}: ResourcesFilterCardProps) => {
  ...
  const normalizedInitialFilters = useMemo(() => {
    const f: Partial<ResourcesQueryParams> = {};
  ...
  useEffect(() => {
    const filters: Partial<ResourcesQueryParams> = {};
...
ResourcesFilterCard.displayName = "ResourcesFilterCard";

export default ResourcesFilterCard;
