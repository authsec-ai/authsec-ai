...
// Role query parameters interface
...
export interface RolesFilterCardProps {
  onFiltersChange: (filters: Partial<RolesQueryParams>) => void;
  initialFilters?: Partial<RolesQueryParams>;
  rolesData?: RoleData[];
}

const RolesFilterCard = React.memo(({
  onFiltersChange,
  initialFilters = {},
  rolesData: _rolesData = []
}: RolesFilterCardProps) => {
  ...
  const normalizedInitialFilters = useMemo(() => {
    const f: Partial<RolesQueryParams> = {};
  ...
  useEffect(() => {
    const filters: Partial<RolesQueryParams> = {};
...
RolesFilterCard.displayName = "RolesFilterCard";

export default RolesFilterCard;
