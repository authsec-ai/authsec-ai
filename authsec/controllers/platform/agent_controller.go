...
func (ac *AgentController) ProvisionIdentity(c *gin.Context) {
	...
	spireResp, err := ac.spireService.CreateAgentEntry(&services.SpireCreateAgentEntryRequest{
...
func (ac *AgentController) DelegateToken(c *gin.Context) {
	...
	jwtResp, err := ac.spireService.IssueDelegatedJWTSVID(&services.SpireIssueJWTSVIDRequest{
		TenantID:     tenantID.String(),
